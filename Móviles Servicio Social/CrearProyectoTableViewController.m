//
//  CrearProyectoTableViewController.m
...
@interface CrearProyectoTableViewController ()

@end

@implementation CrearProyectoTableViewController
...
- (IBAction)crearProyecto:(UIBarButtonItem *)sender{
    ...
    if (![nombre isEqualToString:@""] && ![descripcion isEqualToString:@""]){
        
        [self.delegado crearProyecto:nombre withDes:descripcion];
