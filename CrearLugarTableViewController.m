//
//  CrearLugarTableViewController.m
...
@interface CrearLugarTableViewController ()

@end

@implementation CrearLugarTableViewController
...
- (IBAction)crearLugar:(UIBarButtonItem *)sender{
    ...
    if (![nombre isEqualToString:@""] && ![direccion isEqualToString:@""]){
        
        [self.delegado crearLugar:nombre withDir:direccion];
